...
#define WIFI_PSK	"3ge6oiRShrSZQa96"

static uint8_t wifi_ssid[] = WIFI_SSID;
static size_t wifi_ssid_len = sizeof(WIFI_SSID) - 1;
static uint8_t wifi_psk[] = WIFI_PSK;
static size_t wifi_psk_len = sizeof(WIFI_PSK) - 1;
...
K_THREAD_STACK_DEFINE(wifi_manager_work_q_stack, 4096);
...
SYS_INIT(wifi_manager_init, APPLICATION, 90);
